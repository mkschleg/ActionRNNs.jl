...
begin
	load_at = local_data
	save_at = "../../processed_data/ringworld_10.jld2"
	results_folders = ["ringworld/ringworld_er_rnn_rmsprop_10/"]
	settings_filter = ["_GIT_INFO", "_SAVE", "save_dir"]
end;

# ╔═╡ 67d58fe0-6b1f-43a9-8c48-321bd9c5c518
begin
	line_params = ["cell", "outhorde", "hs_learnable", "numhidden", "truncation", "update_freq"]
	sweep_params = ["eta"]
end;
