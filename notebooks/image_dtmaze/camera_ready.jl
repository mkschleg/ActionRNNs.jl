...
# ╔═╡ e879b043-61ee-472d-9c95-07aa7ffe1753
s_dir

# ╔═╡ f6f0e7c1-a80f-43cd-bb4c-ea0438c473d7
df_final_tmaze = FileIO.load(at("final_image_dir_tmaze_adam_6/2022_05_21_proc_data.jld2"))["params_and_results"]

# ╔═╡ 6244b0ef-6734-4007-9067-e218191b3b79
df_fac_tmaze = FileIO.load(at("final_image_fac_dir_tmaze_adam_6/2022_05_21_proc_data.jld2"))["params_and_results"]

# ╔═╡ 6b0e3ce9-cf5c-4666-b1f9-7953ed5a3596
df_deep_action_tmaze = FileIO.load(at("image_dir_tmaze_deep_a_aagru/2022-06-17-dataproc.jld2"))["params_and_results"]
...
# ╔═╡ a0a855b0-bf18-4aca-9601-caf840c5db7e
 @from i in best_over_eta_deep_action begin
		@where i.cell=="AAGRU" && 
			   ...
			   i.truncation == 20
		@select {
			d=getindex(i, :successes_avg_end),
	 		numhidden=i.numhidden,
			internal_a = i.internal_a
			}
		@collect DataFrame
 end

# ╔═╡ 99417a92-66ea-4e9d-be42-24340c44e931
DataFrameUtils.get_diff_dict(df_final_tmaze)
