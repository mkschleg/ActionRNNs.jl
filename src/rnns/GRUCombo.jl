...
struct CaddElGRUCell{A,V,T,S}  <: AbstractActionRNN
    θa::V
    θm::V
    Wia::A
    Wa::A
...
function (m::CaddElGRUCell)(h, x::Tuple{A, O}) where {A, O}
    o = size(h, 1)
