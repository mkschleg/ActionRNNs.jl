...
#SBATCH -o tmaze_online.out # Standard output
#SBATCH -e tmaze_online.err # Standard error
...
reproduce_config_experiment("configs/tmaze_online/tmaze_online_10.toml";
